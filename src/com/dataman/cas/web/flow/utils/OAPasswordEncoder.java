 ...
 * @since 3.1
 */
public final class OAPasswordEncoder implements PasswordEncoder {

	private String encodingAlgorithm = "MD5";

	public OAPasswordEncoder(final String encodingAlgorithm) {
	...
	public String encode(final String password) {
		...
		return (ecpwd != null && ecpwd.length() == 32) ? ecpwd
				: password;
	}
}
